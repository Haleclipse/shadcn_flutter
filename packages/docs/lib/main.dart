  ...
  Widget build(BuildContext context) {
    return Data.inherit(
      ...
      child: ShadcnApp.router(
        ...
        // The docs demonstrate both Material and Cupertino interop, so both
        // sets of delegates are registered app-wide. They have to be here
        // rather than on the MaterialLayer/CupertinoLayer inside each example:
        // showDialog and showCupertinoDialog push onto the root navigator, and
        // that route content builds outside those layers.
